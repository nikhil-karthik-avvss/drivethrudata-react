          ...
          <div className={`contact__left fade-in ${visible ? 'visible' : ''}`}>
            ...
            <div className="contact-info-list">
              {[
                ...
                { label: 'Address', value: '43 B, Velachery Main Road, Chennai - 600 042', href: 'https://maps.google.com/?q=43+B+Velachery+Main+Road+Chennai', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg> },
              ].map(item => (
